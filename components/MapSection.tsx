    ...
    <>
      <section className="p-6">
        ...
        <div className="mt-8 space-y-6">
          ...
          >
            <div className="space-y-3">
              ...
              <div className="ml-4 space-y-2">
                ...
                <div className="flex items-center gap-2" style={{ marginBottom: "0" }}><Dot className="bg-orange-500" /><span className="text-lg text-gray-700">시외버스: 88(부천), 737(수원/안산),</span></div>
                <div className="flex items-center" style={{ marginLeft: "15px" }}><span className="text-lg text-gray-700">8414(안산), 9500(양재역)</span></div>
              </div>
            </div>
          </Section>
          ...
          >
            <div className="ml-4 space-y-2">
              <div className="flex items-center gap-2"><Dot className="bg-blue-500" />
              ...
              <div className="flex items-center gap-2"><Dot className="bg-cyan-500" />
                <span className="text-lg text-gray-700"><span className="font-medium">인천지하철 1호선</span> 부평역 하차</span>
              </div>
          ...
          >
            <div className="ml-4 space-y-2">
              <div className="flex items-center gap-2"><Dot className="bg-pink-500" />
                <span className="text-lg text-gray-700"><span className="font-medium">내비게이션 :</span></span>
              </div>
              <div className="ml-4 text-lg text-gray-600">“부평역 북부광장, 빌라드마리”, “인천시 부평구 경원대로 1404” 검색</div>
              <div className="flex items-center gap-2"><Dot className="bg-pink-500" />
                <span className="text-lg text-gray-700"><span className="font-medium">서울 방향 :</span></span>
              </div>
              <div className="ml-4 text-lg text-gray-600">서울외곽순환도로 → 경인고속도로 → 부평 IC → 부평역 북부광장 방면</div>
              <div className="flex items-center gap-2"><Dot className="bg-pink-500" />
                <span className="text-lg text-gray-700"><span className="font-medium">인천 방향 :</span></span>
              </div>
              <div className="ml-4 text-lg text-gray-600">경인고속도로 부평 IC → 부평역 북부광장 방면</div>
              <div className="flex items-center gap-2"><Dot className="bg-pink-500" />
                <span className="text-lg text-gray-700"><span className="font-medium">부천 방향 :</span></span>
              </div>
              <div className="ml-4 text-lg text-gray-600">길주로(부일로) 직진 → 부평역 북부광장 방면</div>
              <div className="flex items-center gap-2"><Dot className="bg-pink-500" />
                <span className="text-lg text-gray-700"><span className="font-medium">계양 방향 :</span></span>
              </div>
              <div className="ml-4 text-lg text-gray-600">계산오거리 → 경원대로 직진 → 부평역 북부광장 방면</div>
            </div>
          </Section>
